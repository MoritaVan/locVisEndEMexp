...
saccade_polar_ang = np.deg2rad(np.arange(analysis_info['ang_start_sac'],360+analysis_info['ang_start_sac'],analysis_info['ang_steps'])+180)
...
polar_ang = np.deg2rad(np.arange(analysis_info['ang_start_sac'],360+analysis_info['ang_start_sac'],analysis_info['ang_steps']))
...
for run in runs:
	...
	for sequence in eye_mov_seq:
		...
		for trial_num,trial_plot in enumerate(trials_seq):
			...
			plot_color = saccade_col_mat[np.mod(trial_num,4),:]
