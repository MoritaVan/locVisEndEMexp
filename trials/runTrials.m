        ...
        while nbf < const.TR_num
            ...
            if const.checkTrial && const.expStart == 0
                ...
                for tDir = 1:size(const.purs_start,2)
                    Screen('DrawLine',scr.main,const.gray,scr.x_mid,scr.y_mid,const.pursuit_matX(1,size(const.eyemov_ampVal,2),(tDir-1)*9+1),const.pursuit_matY(1,size(const.eyemov_ampVal,2),(tDir-1)*9+1));
                end
